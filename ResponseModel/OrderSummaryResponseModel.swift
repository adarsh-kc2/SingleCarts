//
//  OrderSummaryResponseModel.swift
//  SingleCart
//
...
import Foundation
struct OrderSummaryResponseModel : Codable {
    let error : Bool?
    let message : String?
    let hasOrders : Bool?
    let orderSummariesData : [OrderSummariesData]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case orderSummariesData = "orderSummariesData"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        orderSummariesData = try values.decodeIfPresent([OrderSummariesData].self, forKey: .orderSummariesData)
    }

}
struct OrderSummariesData : Codable {
    ...
    let customerAddressResponseData : CustomerAddressResponseData?
    let shopResponseData : ShopResponseData?
    ...
    init(from decoder: Decoder) throws {
        ...
        customerAddressResponseData = try values.decodeIfPresent(CustomerAddressResponseData.self, forKey: .customerAddressResponseData)
        shopResponseData = try values.decodeIfPresent(ShopResponseData.self, forKey: .shopResponseData)
    }

}
struct CustomerAddressResponseData : Codable {
    let address1 : String?
    let address2 : String?
    let addressID : Int?
    let area : String?
