...
class Webservice{
    ...
    // checkUpdates
    func checkDuplicates(body: Dictionary<String,Any>,completionBlock : @escaping(CheckUpdateResponseModel?,String?) -> ()){
        let url = URL(string : BASE_URL + CUSTOMER_SIGNUP_OTP)//CHECKSIGNUP)
        do {
            let request  = getRequest(url: url!, method: .post, auth: false, accept: .json, Content_Type: .json, body: body)
            let task = URLSession.shared.dataTask(with: request) { (data, response, error) in
                let jsonDecoder = JSONDecoder()
                ...
                do{
                    if let error = error{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if (offer?.error)! == true{
                                if offer?.message! == ERROR_MESSAGE{
                ...
                do{
                    if let error = error{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if (shops?.error)! == true{
                                if shops?.message! == ERROR_MESSAGE{
                                    completionBlock(nil, nil)
                                }else{
                ...
                do{
                    if let error = error{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if (flyer?.error)! == true{
                                if flyer?.message! == ERROR_MESSAGE{
                                    completionBlock(nil, nil)
                                }else{
                    ...
                    if let error = error{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if (favourite?.error)! == true{
                                if favourite?.message! == ERROR_MESSAGE{
                                    completionBlock(nil, nil)
                                }else{
                    ...
                    if let error = error{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if (account?.error)! == true{
                                if account?.message! == ERROR_MESSAGE{
                                    completionBlock(nil, nil)
                                }else{
                    ...
                    if let error = error{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if (address?.error)! == true{
                                if address?.message! == ERROR_MESSAGE{
                                    completionBlock(nil, nil)
                                }else{
                    ...
                    if let error = error{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if (change?.Error)! == true{
                                if change?.Message! == ERROR_MESSAGE{
                                    completionBlock(nil, nil)
                                }else{
                    ...
                    if let error = error{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if (delete?.Error)! == true{
                                if delete?.Message! == ERROR_MESSAGE{
                                    completionBlock(nil, nil)
                                }else{
                    ...
                    if let error = error{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if (shopDetail?.error)! == true{
                                if shopDetail?.message! == ERROR_MESSAGE{
                                    completionBlock(nil, nil)
                                }else{
                    ...
                    if let error = error{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if (review?.error)! == true{
                                if review?.message! == ERROR_MESSAGE{
                                    completionBlock(nil, nil)
                                }else{
                    ...
                    if let error = error{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if (common?.error)! == true{
                                if common?.message! == ERROR_MESSAGE{
                                    completionBlock(nil, nil)
                                }else{
                    ...
                    if let error = error{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if (getWishList?.error)! == true{
                                if getWishList?.message! == ERROR_MESSAGE{
                                    completionBlock(nil, nil)
                                }else{
                    ...
                    if let error = error{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if (getCartList?.error)! == true{
                                if getCartList?.message! == ERROR_MESSAGE{
                                    completionBlock(nil, nil)
                                }else{
                    ...
                    if let error = error{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if (orderList?.error)! == true{
                                if orderList?.message! == ERROR_MESSAGE{
                                    completionBlock(nil, nil)
                                }else{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if placeOrder != nil{
                                if (placeOrder?.error)! == true{
                                    if placeOrder?.message! == ERROR_MESSAGE{
                                        completionBlock(nil, nil)
                                    }else{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if orderDetails != nil{
                                if (orderDetails?.error)! == true{
                                    if orderDetails?.message! == ERROR_MESSAGE{
                                        completionBlock(nil, nil)
                                    }else{
                        ...
                        if (response as? HTTPURLResponse)?.statusCode != 200{
                            ...
                            if shopCategory != nil{
                                if (shopCategory?.error)! == true{
                                    if shopCategory?.message! == ERROR_MESSAGE{
                                        completionBlock(nil, nil)
                                    }else{
...
//GETDASHBOARD_DATA
    ...
    func getSummaryData(body: Dictionary<String,Any>,completionBlock : @escaping(SummaryDataResponseModel?,String?) -> ()){
        ...
        do {
            let request  = getRequest(url: url!, method: .post, auth: false, accept: .json, Content_Type: .json, body: body)
            Webservice.task = URLSession.shared.dataTask(with: request) { (data, response, error) in
                let jsonDecoder = JSONDecoder()
                do{
                    if let error = error{
                        debugPrint(error.localizedDescription)
    ...
    func updateTone(body: Dictionary<String,Any>,completionBlock : @escaping(CommonResponseModel?,String?) -> ()){
