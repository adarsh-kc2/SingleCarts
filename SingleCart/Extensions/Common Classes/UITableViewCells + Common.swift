...
class FlyerTableViewCell: UITableViewCell{
    ...
    @IBOutlet weak var flyerHeightConstraint: NSLayoutConstraint!
...
class ShopDetailTableViewCell: UITableViewCell{
    @IBOutlet weak var reviewBurron: UIButton!
...
//    cell4
    ...
    @IBOutlet weak var flyerImageCollectionView: UICollectionView!
    @IBOutlet weak var flowLayout: UICollectionViewFlowLayout!
    @IBOutlet weak var flyerShop: UILabel!
...
class productDetailTableViewCell : UITableViewCell{
    ...
    @IBOutlet weak var offerPercentageButton: UIButton!
...
//    cell 4
    ...
    @IBOutlet weak var offeNotesLabel: UILabel!
    @IBOutlet weak var productFlowLayout: UICollectionViewFlowLayout!
...
class FeedTableViewCell : UITableViewCell{
    ...
    @IBAction func productOfferButton(_ sender: Any) {
    }
...
class FeedProductTableViewCell : UITableViewCell{
    ...
    @IBOutlet weak var productOfferButton: UIButton!
